...
public class AdapterForCategoryAdd extends RecyclerView.Adapter<AdapterForCategoryAdd.MyViewHolder> {
    ...
    public AdapterForCategoryAdd(Context mContext, ArrayList<category> cats) {
    ...
    @Override
    public AdapterForCategoryAdd.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
